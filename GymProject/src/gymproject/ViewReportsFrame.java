...
public class ViewReportsFrame extends JFrame {
    ...
    public ViewReportsFrame(BookingDatabase booking, SportDatabase sportList1, MemberDatabase memberList, HallDatabase hallList1 ) {
        ...
        bookingList.addListSelectionListener(new ViewReportsFrame.ListListener());
        ...
        cancelButton.addActionListener(new ViewReportsFrame.CancelListener());
        JButton clearButton = new JButton("Clear");
        clearButton.addActionListener(new ViewReportsFrame.ClearListener());
